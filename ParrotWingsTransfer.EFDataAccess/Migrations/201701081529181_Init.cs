namespace ParrotWingsTransfer.EFDataAccess.Migrations
{
    ...
    public partial class Init : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        CreditAccount_Id = c.Guid(),
                        DebitAccount_Id = c.Guid(),
                    })
                .PrimaryKey(t => t.Id)
        ...
        {
            DropForeignKey("dbo.AccountTransactions", "DebitAccount_Id", "dbo.Accounts");
            DropForeignKey("dbo.AccountTransactions", "CreditAccount_Id", "dbo.Accounts");
            DropForeignKey("dbo.AspNetUserRoles", "RoleId", "dbo.AspNetRoles");
            DropForeignKey("dbo.AspNetUsers", "Account_Id", "dbo.Accounts");
            DropForeignKey("dbo.AspNetUserRoles", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropIndex("dbo.AccountTransactions", new[] { "DebitAccount_Id" });
            DropIndex("dbo.AccountTransactions", new[] { "CreditAccount_Id" });
